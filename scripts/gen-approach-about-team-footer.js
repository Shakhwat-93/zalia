...
export default function Footer() {
  ...
  return (
    <footer className="relative w-full bg-white text-charcoal-900 border-t border-canvas-border pt-16 sm:pt-20 pb-12 overflow-hidden">
      <div className="max-w-7xl mx-auto px-6 sm:px-8 space-y-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8">
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-xs sm:text-sm text-charcoal-600 max-w-sm leading-relaxed font-normal">
            ...
            <div className="pt-2 space-y-2 text-xs text-charcoal-600 font-mono">
              <div className="flex items-center space-x-3">
          ...
          <div className="lg:col-span-3 space-y-4">
            <h4 className="text-xs font-mono font-semibold uppercase tracking-widest text-emerald-brand">
              Navigation
            </h4>
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            <div className="p-5 rounded-2xl bg-canvas-warm border border-canvas-border space-y-3">
              <div className="text-xs font-serif text-charcoal-900 font-medium">
              ...
              <div className="text-[10px] font-mono text-emerald-brand uppercase tracking-wider pt-1">
        ...
        <div className="pt-8 border-t border-canvas-border flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-charcoal-400 font-mono">
          <div>
...
console.log('Approach, About, Team, CTA, Footer generated.');