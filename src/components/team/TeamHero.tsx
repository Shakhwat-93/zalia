      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <motion.div style={{ y: heroY }} className="space-y-6 max-w-4xl text-left">
          ...
          <p className="text-lg sm:text-xl text-charcoal-600 font-sans leading-relaxed font-normal max-w-2xl pt-2">
            A multidisciplinary collective spanning property acquisition, interior architecture, structural engineering, and client stewardship — united by a singular standard of British craft.
          </p>
        </motion.div>
      </div>
    </section>
