...
export default function HomeIntro({ data }: HomeIntroProps) {
  ...
  const headline = data?.headline || 'WE SEE MORE IN EVERY PROPERTY.';
  const description = data?.subheadline || 'We look beyond what a property is today to understand what it could become tomorrow.';
  const ctaLabel = data?.primary_cta_label || 'Discover Who We Are';
  const ctaHref = data?.primary_cta_href || '/about';
  const image = data?.media_url || '/images/about-zalia.webp';
      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 sm:space-y-8 text-left">
            ...
            >
              {headline.includes('IN EVERY PROPERTY') ? (
                <>
                  WE SEE MORE
